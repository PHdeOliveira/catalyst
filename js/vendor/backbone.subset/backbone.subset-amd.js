 ...
 * @desc   Implements a collection that is a subset other Backbone Collections - modified for AMD
*/
...
(function (root, factory) {
  ...
  Backbone.Subset = (function(Backbone, _) {  
  	"use strict";

  
  	var Subset = function(models, options) {
	  ...
	  _.extend(Subset.prototype, Backbone.Collection.prototype, {
	    ...
	    return _.result(this, 'parent').add(model, options);
		   ...
		   * @return {Object} model
		   */
		  _addToSubset: function (model, options) {
	    if (this.sieve(model)) {
	    ...
	    return _.result(this, 'parent').remove(model, options);
		   ...
		   * @return {Object} model
		   */
		  _removeFromSubset: function (model, options) {
	    ...
	    return model;
		   ...
		   * @param {Object} options
		   */
		  _proxyAdd: function (model, collection, options) {
	    options = options || {};
	    ...
	    if (collection !== this && this.sieve(model) && !options.noproxy) {
		   ...
		   * @param {Object} options
		   */
		  _proxyRemove: function (model, collection, options) {
	    options = options || {};
	    ...
	    if (collection !== this && this.sieve(model) && !options.noproxy) {
		   ...
		   * @param {Object} collection
		   */
		  _proxyChange: function (ev, model, collection) {
	    if (collection !== this && ev === 'change' && this.liveupdate_keys === 'all') {
		   ...
		   * @param {Object} options
		   */
		  _proxyReset: function (collection, options) {
	    options = options || {};
	    ...
	    if ((!options || !options.noproxy) && (!options.model_ids || this === collection || getSievedModels().length)) {
		   ...
		   */
		  _updateModelMembership: function (model, options) {
	    var hasId = !model.id
