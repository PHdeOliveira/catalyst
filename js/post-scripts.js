...
$(function() {
    ...
    $.getJSON('http://catalyst.playitbypixels.com/php/get-tweets.php', function(data) {
        ...
        for (var i = 0; i < tweets.length; i++) {
            ...
            twitterContainer[i].prepend('<p class="sm-text">' + text + '</p><a href="https://twitter.com/CatalystLeader/statuses/' + tweets[i].user.screen_name + '/' + tweets[i].id + '" class="sm-date">' + r + '</a>');
        }
    }).done(function() {
        $('.the-icons').hide();
